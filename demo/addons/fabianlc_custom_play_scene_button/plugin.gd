...
var icon = preload("res://KINKER_icon.png")
...
func _enter_tree():
	...
	if i == 1:
		...
		custom_play_button.icon = icon
		custom_play_button.set_size(Vector2(16, 16))
...
func play_game_pressed():
	OS.execute("C:\\Users\\wridz\\Documents\\CppGodot\\compileCPP.bat", [], true)
